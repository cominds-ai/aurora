        ...
        <FieldSet>
          ...
          <FieldGroup>
            ...
            <Field>
              ...
              />
              <FieldDescription className="text-xs">
                请填写 Aurora 调用的模型名字，模型必须支持工具调用、图像识别等功能。
              </FieldDescription>
            </Field>
            <Field>
...
function SearchSetting({config, onChange}: SearchSettingProps) {
  ...
  return (
    <form className="w-full px-1" onSubmit={(e) => e.preventDefault()}>
      <FieldGroup>
        <FieldSet>
          <FieldLegend className="text-lg font-bold text-gray-700">Google 搜索</FieldLegend>
          <FieldGroup>
            <Field>
              <FieldLabel htmlFor="search_provider">搜索提供商</FieldLabel>
              <Input id="search_provider" value={config.provider ?? 'serpapi_google'} disabled />
            </Field>
            <Field>
              <FieldLabel htmlFor="search_api_key">SerpAPI API Key</FieldLabel>
              <Input
                id="search_api_key"
                type="password"
      ...
      <FieldGroup>
        <FieldSet>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription className="text-gray-500">
                    Aurora 使用标准的 A2A 协议来连接远程 Agent。
                    <br/>
                    ...
                    <FieldSet>
                      <Field>
                        <Input
                          id="a2a_base_url"
                          type="url"
                          placeholder="Example: https://aurora.com/weather-agent"
                          value={addUrl}
          ...
          <FieldDescription className="text-sm">
            模型上下文协议 (MCP) 通过集成外部工具来增强 Aurora 的性能，例如私有域搜索、网页浏览、订餐、PPT 生成等任务。
          </FieldDescription>
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="!max-w-[850px]">
        ...
        <DialogHeader className="border-b pb-4">
          <DialogTitle className="text-gray-700">Aurora 设置</DialogTitle>
          <DialogDescription className="text-gray-500">在此管理当前地球人的 Aurora 设置。</DialogDescription>
        </DialogHeader>

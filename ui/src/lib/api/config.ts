...
export const configApi = {
  ...
  getSearchConfig: (): Promise<SearchConfig> => {
    return get<SearchConfig>("/app-config/search");
  },

  updateSearchConfig: (config: SearchConfig): Promise<SearchConfig> => {
    return post<SearchConfig>("/app-config/search", config);
  },
  ...
  ): Promise<SandboxPreference> => {
    return post<SandboxPreference>("/app-config/sandbox-preference", config);
  },

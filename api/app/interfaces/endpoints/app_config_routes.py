...
@router.get(
    path="/search",
    response_model=Response[SearchConfig],
    summary="获取搜索配置",
)
async def get_search_config(
    ...
    return Response.success(data=search_config.model_dump(exclude={"api_key"}))
...
async def update_search_config(
    ...
    return Response.success(data=updated_search_config.model_dump(exclude={"api_key"}), msg="更新搜索配置成功")

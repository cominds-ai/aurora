...
const getInteractiveElements = () => {
    ...
    for (let i = 0; i < elements.length; i++) {
        ...
        // 24.为当前元素添加data-aurora-id的属性，值为aurora-element-idx，这样可以通过索引找到对应的元素
        element.setAttribute('data-aurora-id', `aurora-element-${validElementIndex}`);

        // 25.构建css选择器
        const selector = `[data-aurora-id="aurora-element-${validElementIndex}"]`;
